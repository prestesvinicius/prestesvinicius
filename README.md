...
<details>
 <summary><h3>⏰ Detecção de falhas em sinais temporais </h3></summary>
   ...
   Os dados utilizados são da base de dados [MAFAULDA]([URL_do_Link](https://www02.smt.ufrj.br/~offshore/mfs/page_01.html)). A análise e preparação dos dados em formato de série temporal foi desafiadora e aprendi bastante praticando com esses dados.
  ...
  * Redução de Dimensonalidade de Datasets
  * Construção de Modelos de Classificação
